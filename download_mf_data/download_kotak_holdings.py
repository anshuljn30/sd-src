...
def download(dates):
    file_path = "C:\\Users\\Administrator\\Documents\\sd-src\\sql_data\\mutual_fund_data\\raw\\kotak\\"
    chrome_driver = "C:\\Users\\Administrator\\Downloads\\chromedriver_win32\\chromedriver.exe"
    driver = webdriver.Chrome(executable_path=chrome_driver)
    driver.get("https://assetmanagement.kotak.com/portfolios")
    ...
    for d in dates:
        ...
        save_file_name = "kotak_portfolios_" + d.strftime('%Y%m') + '.xlsx'
